                            ...
                            for message in history['messages']:
                                ...
                                if member_id == member['id']:
                                    if 'client_msg_id' in message:
                                        ...
                                        if 'files' in message:
                                            attachment_ids =[]
                                            # attachment_ids = self.getAttachments(message)
...
class OdooDiscussions(models.Model):
    ...
    #     res_id = super(OdooDiscussions, self).create(values)
    #     return res_id
    #
    #     # self.import_slack_conversation()
    ...
    ####################################################################################################################
        ...
        #
        #                     ts = float(message['ts'])
        #                     previous_date = (datetime.now() - timedelta(hours=1)).timestamp()
        #                     if ts < previous_date:
        #                         break
        #                     else:
        #                         date_time = datetime.fromtimestamp(ts)
...
class MailChannelUser(models.Model):
    ...
    # current_user = fields.Char(compute='is_current')
