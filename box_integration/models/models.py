    ...
    def generate_refresh_token(self):
        ...
        if self.user_name_google.refresh_token:
            ...
            response = requests.post(
                ...
                data='grant_type=refresh_token&client_id=' + self.user_name_google.client_id +
                     '&client_secret=' + self.user_name_google.client_secret + '&refresh_token=' +
                     self.user_name_google.refresh_token, headers=header).content
        ...
        for folder in all_folder:
            if folder.name == self.name:
                ...
                for files in all_files:
                    file_url = client.file(file_id=files['id']).create_shared_link(allow_download=True,
                                                                                   allow_preview=True,
                                                                                   password=None).shared_link['url']
