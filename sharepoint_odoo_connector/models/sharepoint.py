...
from . import sp_session


class SharePointIntegration(object):
    """ create, delete files and folders in shareoint.
        To update files and folders list in odoo.
    """
    def __init__(self, url, email, password):
        """Constructor for URL and share-point session check"""
    ...
    def download_file_from_link(self, site_name, document_folder_name, file_name, folder_name, document_link_url,
                                save_to_file_path='temp.txt'):
        try:
